...
package org.lazulite.boot.autoconfigure.osaam.shiro.util;
...
public class LogUtils {
    ...
    protected static String getParams(HttpServletRequest request) throws JsonProcessingException {
    ...
    private static String getHeaders(HttpServletRequest request) throws JsonProcessingException {
